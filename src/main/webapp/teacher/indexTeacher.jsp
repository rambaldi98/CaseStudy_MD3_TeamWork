...
<%--&lt;%&ndash;<h2><a href="/teacher?action=listStudent">danh sách học sinh </a></h2>&ndash;%&gt;--%>
...
<div class="wrapper col2">
    <div id="topnav">
        <ul>
            <li class="active"><a href="/teacher">Home</a>
                <%--                <ul>--%>
            ...
            <li><a href="/teacher?action=listClass">List Class</a>

            </li>
            <li><a href="/teacher?action=writeDiaryClass">Write diary</a>
                <%--                <ul>--%>
